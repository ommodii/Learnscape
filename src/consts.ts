...
export const SITE: Site = {
  ...
  href: 'https://app.netlify.com/projects/jazzy-pithivier-4fc17d/',
  author: 'Om Modi',
  locale: 'en-US',
  featuredPostCount: 2,
  postsPerPage: 6,
...
export const BREVO = {
  ...
  templateId: import.meta.env.BREVO_TEMPLATE_ID,
}
...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  {
    href: 'mailto:om_modi09@icloud.com',
    label: 'Email',
  },
  {
    href: '/rss.xml',
